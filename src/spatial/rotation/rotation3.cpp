...
epr::math::Matrix3 epr::spatial::Rotation3::create_yaw_matrix() {
    ...
    temp.data[0][0] = std::cos(yaw); temp.data[0][2] = std::sin(yaw);
    temp.data[2][0] = -std::sin(yaw); temp.data[2][2] = std::cos(yaw);
...
epr::math::Matrix3 epr::spatial::Rotation3::create_pitch_matrix() {
    ...
    temp.data[1][1] = std::cos(pitch); temp.data[1][2] = -std::sin(pitch);
    temp.data[2][1] = std::sin(pitch); temp.data[2][2] = std::cos(pitch);
...
epr::math::Matrix3 epr::spatial::Rotation3::create_roll_matrix() {
    ...
    temp.data[0][0] = std::cos(roll); temp.data[0][1] = -std::sin(roll);
    temp.data[1][0] = std::sin(roll); temp.data[1][1] = std::cos(roll);
